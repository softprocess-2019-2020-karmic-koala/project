...
class __TwigTemplate_28fc8aa83a9dea56ae903554f48edd7ea29a014e504a26f78f877dd72b0f468d extends \Twig\Template
{
...
\t\t\t\t";
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["auth"]) {
                // line 78
                echo "\t\t\t\t\t";
                if ($this->getAttribute($context["auth"], "S_YES", [])) {
                    // line 79
                    echo "\t\t\t\t\t\t<li class=\"permissions-preset-yes";
                    if ($this->getAttribute($context["auth"], "S_FIRST_ROW", [])) {
                        echo " activetab";
                    }
                    echo "\" id=\"tab00";
                    echo $this->getAttribute($context["auth"], "S_ROW_COUNT", []);
                    echo "\">
\t\t\t\t\t";
                } elseif ($this->getAttribute(                // line 80
$context["auth"], "S_NEVER", [])) {
                    // line 81
...
\t\t\t\t\t";
                ...
                echo $this->getAttribute($context["auth"], "CAT_NAME", []);
                echo "</span></a></li>\t
\t\t\t\t";
            }
...
\t\t\t\t\t";
                // line 110
                $context['_parent'] = $context;
                $context['_seq'] = twig_ensure_traversable($this->getAttribute($context["auth"], "mask", []));
...
\t\t\t\t\t\t<td class=\"permissions-yes\"><label for=\"setting_";
                    // line 114
                    echo $this->getAttribute($context["mask"], "FIELD_NAME", []);
...
\t\t<td style=\"vertical-align: top;\"><strong>";
                // line 156
                echo $this->getAttribute($context["roles"], "ROLE_NAME", []);
                echo "</strong>
\t\t\t";
                // line 157
                if ($this->getAttribute($context["roles"], "ROLE_DESCRIPTION", [])) {
                    echo "<br /><span>";
                    echo $this->getAttribute($context["roles"], "ROLE_DESCRIPTION", []);
                    echo "</span>";
                }
                // line 158
                echo "\t\t</td>
\t\t<td style=\"width: 30%; text-align: center; vertical-align: top; white-space: nowrap;\">";
                // line 159
                if ($this->getAttribute($context["roles"], "U_DISPLAY_ITEMS", [])) {
                    echo "<a href=\"";
                    echo $this->getAttribute($context["roles"], "U_DISPLAY_ITEMS", []);
                    echo "\">";
...
\t\t\t<span class=\"up\"><a href=\"";
                // line 162
                echo $this->getAttribute($context["roles"], "U_MOVE_UP", []);
...
\t\t\t<span class=\"down\"><a href=\"";
                // line 164
                echo $this->getAttribute($context["roles"], "U_MOVE_DOWN", []);
                echo "\" data-ajax=\"row_down\">";
                echo (isset($context["ICON_MOVE_DOWN"]) ? $context["ICON_MOVE_DOWN"] : null);
                echo "</a></span>
\t\t\t<a href=\"";
                // line 165
                echo $this->getAttribute($context["roles"], "U_EDIT", []);
                echo "\" title=\"";
...
\t\t\t<a href=\"";
                // line 166
                echo $this->getAttribute($context["roles"], "U_REMOVE", []);
                echo "\" title=\"";
...
";
    ...
    {
        return array (  598 => 191,  595 => 190,  591 => 188,  587 => 186,  575 => 185,  570 => 183,  565 => 180,  563 => 179,  556 => 175,  541 => 174,  535 => 170,  521 => 166,  513 => 165,  507 => 164,  503 => 163,  497 => 162,  493 => 161,  480 => 159,  477 => 158,  471 => 157,  467 => 156,  464 => 155,  460 => 154,  453 => 150,  449 => 149,  440 => 143,  435 => 141,  430 => 139,  427 => 138,  420 => 134,  413 => 130,  409 => 129,  402 => 124,  392 => 119,  373 => 116,  359 => 115,  345 => 114,  333 => 112,  326 => 111,  322 => 110,  311 => 106,  303 => 105,  295 => 104,  291 => 103,  279 => 94,  268 => 92,  264 => 91,  260 => 89,  249 => 87,  239 => 85,  229 => 83,  227 => 82,  218 => 81,  216 => 80,  207 => 79,  204 => 78,  200 => 77,  190 => 70,  182 => 65,  175 => 60,  171 => 58,  159 => 57,  154 => 55,  151 => 54,  149 => 53,  142 => 49,  138 => 48,  131 => 44,  124 => 43,  118 => 40,  113 => 39,  108 => 37,  102 => 34,  97 => 32,  91 => 29,  86 => 27,  77 => 25,  70 => 20,  64 => 18,  62 => 17,  49 => 6,  47 => 5,  42 => 2,  30 => 1,);
    }
